 ...
 */
 $sample="'Joy is the serious business of heaven.'.LEWIS,CLIVE STAPLES.1964-01-01.https://bit.ly/2HwPJd6
...
echo "($i)"."<a href='link.php?ipnum={$result[0]} '>".$newword3[1]."</a>"." ".$newword3[0]."(# ".$newword2[4]." (0) ".$newword2[2]."[".$newword2[3]."])<br><br>";
